...
All environment variabels should start with "CODENAMES_" prefix.

For example if you see in your "codenames/settings.py" a variable named like
`random_parameter`, you should provide the "CODENAMES_RANDOM_PARAMETER"
variable to configure the value. This behaviour can be changed by overriding `env_prefix` property
in `codenames.settings.Settings.Config`.

An exmaple of .env file:
```bash
CODENAMES_RELOAD="True"
CODENAMES_PORT="8000"
CODENAMES_ENVIRONMENT="dev"
```
